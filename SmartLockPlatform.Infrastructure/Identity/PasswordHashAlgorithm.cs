...
internal sealed class PasswordHashAlgorithm : IPasswordHashAlgorithm
{
     ...
     *
     * Version 3:
     * PBKDF2 with HMAC-SHA256, 128-bit salt, 256-bit subKey, 10_000 iterations.
     * Format: { 0x01, prf (UInt32), iteration count (UInt32), salt length (UInt32), salt, subKey }
     * (All UInt32s are stored big-endian.)
     */
    private const int IterationCount = 10_000; //TODO: Increasing iteration count causes performance issues in batch processing
    ...
    private static byte[] HashPasswordInternal(string password, KeyDerivationPrf prf = KeyDerivationPrf.HMACSHA256,
    ...
    private static bool VerifyHashedPasswordInternal(byte[] hashedPassword, string providedPassword,
